...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["orders-orders-module"], {
  ...
  function srcAppOrdersOrderDetailedOrderDetailedComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function OrderDetailedComponent_div_1_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("items", ctx_r89.order.orderItems)("isBasket", false)("isOrder", true);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("shippingPrice", ctx_r89.order.total - ctx_r89.order.subtotal)("subtotal", ctx_r89.order.subtotal)("total", ctx_r89.order.total);
      }
    }
    ...
    function () {
      ...
      _createClass(OrderDetailedComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.ordersService.getOrderDetails(+this.route.snapshot.paramMap.get('id')).subscribe(function (order) {
            _this.order = order;

            _this.breadcrumbService.set('@OrderDetails', "Order# ".concat(order.id, " - ").concat(order.status));
          }, function (error) {
            console.log(error);
          });
        }
        ...
        key: "getOrderDetails",
        value: function getOrderDetails() {// this.ordersService.getOrderDetails(+this.route.snapshot.paramMap.get('id'))
  ...
  function srcAppOrdersOrdersRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    _createClass(function OrdersRoutingModule() {
  ...
  function srcAppOrdersOrdersComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function OrdersComponent_tr_15_Template(rf, ctx) {
      ...
      if (rf & 2) {
        var order_r88 = ctx.$implicit;

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpropertyInterpolate1"]("routerLink", "/orders/", order_r88.id, "");

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"]("# ", order_r88.id, "");

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipeBind2"](5, 5, order_r88.orderDate, "medium"));

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](3);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipeBind2"](8, 8, order_r88.total, "INR"));

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](3);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](order_r88.status);
      }
    }
    ...
    /*#__PURE__*/
    function () {
      function OrdersComponent(ordersService, toastr) {
      ...
      _createClass(OrdersComponent, [{
        ...
        value: function getOrders() {
          ...
          this.ordersService.getOrdersForUser().subscribe(function (orders) {
            ...
            _this2.toastr.success('Orders successfully retrieved');
          }, function (error) {
            _this2.toastr.error('Error occurred while retrieving orders');
          });
        }
      }]);
    ...
    OrdersComponent.ɵfac = function OrdersComponent_Factory(t) {
      return new (t || OrdersComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_orders_service__WEBPACK_IMPORTED_MODULE_1__["OrdersService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](ngx_toastr__WEBPACK_IMPORTED_MODULE_2__["ToastrService"]));
    };
  ...
  function srcAppOrdersOrdersModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var OrdersModule =
    /*#__PURE__*/
    _createClass(function OrdersModule() {
